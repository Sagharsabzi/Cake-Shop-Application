...
class ProductListanApp extends StatelessWidget {
  final User user;
  ProductListanApp({required this.user});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ProductListanScreen(user: user),
    );
  }
}
...
class ProductListanScreen extends StatefulWidget {
  ...
  ProductListanScreen({required this.user}); // سازنده با User
...
class _ProductListanScreenState extends State<ProductListanScreen> {
  ...
  String search = '';
  //متغیر سورت تایپ از جنس استرینگ که فعلا مقدار دیفالت دارد ینی ترتیب خاصی نداره لیست محصولات
